...
/**
 * AirportDelayReasons Class Doc Comment
 *
 * @category Class
 * @package  FlightAware\PHPClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AirportDelayReasons implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Airport Delay_reasons';
...
self::COLOR_GREEN,        ];
     ...
     * Sets category
     *
     * @param string $category Category for the delay. Some possible values are \"weather\", \"traffic\", \"equipment\", etc.
     *
     * @return $this
     */
     ...
     * Sets color
     *
     * @param string $color Color indicating severity of delay
     *
     * @return $this
     */
     ...
     * Sets delay_secs
     *
     * @param int $delay_secs Duration of delay (seconds). This value is not intended to be presented to users and should only be used for sorting results.
     *
     * @return $this
     */
     ...
     * Sets reason
     *
     * @param string $reason Textual description of the cause of the delay
     *
     * @return $this
     */
