...
/**
 * OperatorFlightCounts Class Doc Comment
 *
 * @category Class
 * @package  FlightAware\PHPClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OperatorFlightCounts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OperatorFlightCounts';
...
'flights_last_24_hours' => null    ];
    ...
    protected static $attributeMap = [
        'airborne' => 'airborne',
'flights_last_24_hours' => 'flights_last_24_hours'    ];
...
'flights_last_24_hours' => 'setFlightsLast24Hours'    ];
    ...
    protected static $getters = [
        'airborne' => 'getAirborne',
'flights_last_24_hours' => 'getFlightsLast24Hours'    ];
    ...
    {
        $this->container['airborne'] = isset($data['airborne']) ? $data['airborne'] : null;
        $this->container['flights_last_24_hours'] = isset($data['flights_last_24_hours']) ? $data['flights_last_24_hours'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['airborne'] === null) {
            $invalidProperties[] = "'airborne' can't be null";
        }
        if ($this->container['flights_last_24_hours'] === null) {
            $invalidProperties[] = "'flights_last_24_hours' can't be null";
        }
     ...
     * @return int
     */
    public function getAirborne()
    {
        return $this->container['airborne'];
    }

    /**
     * Sets airborne
     *
     * @param int $airborne The number of currently airborne flights for this operator.
     *
     * @return $this
     */
    public function setAirborne($airborne)
    {
        $this->container['airborne'] = $airborne;

        return $this;
    }

    /**
     * Gets flights_last_24_hours
     *
     * @return int
     */
    public function getFlightsLast24Hours()
    {
        return $this->container['flights_last_24_hours'];
    }

    /**
     * Sets flights_last_24_hours
     *
     * @param int $flights_last_24_hours The number of flights departed in the last 24 hours for this operator, including airborne flights.
     *
     * @return $this
     */
    public function setFlightsLast24Hours($flights_last_24_hours)
    {
        $this->container['flights_last_24_hours'] = $flights_last_24_hours;
