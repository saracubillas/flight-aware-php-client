 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AirportRef implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AirportRef';
...
'airport_info_url' => 'getAirportInfoUrl'    ];
     ...
     * Sets code
     *
     * @param string $code ICAO identifier if known, otherwise IATA or LID. For position-only flights, this may also be a string indicating the location where tracking of the flight began/ended.
     *
     * @return $this
     */
     ...
     *
     * @param string $airport_info_url The URL to more information about the airport.
     *
     * @return $this
     */
