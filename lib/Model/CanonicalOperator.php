...
/**
 * CanonicalOperator Class Doc Comment
 *
 * @category Class
 * @package  FlightAware\PHPClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CanonicalOperator implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CanonicalOperator';
...
self::ID_TYPE_IATA,        ];
     ...
     * Sets id
     *
     * @param string $id Operator id for use in the API
     *
     * @return $this
     */
     ...
     * Sets id_type
     *
     * @param string $id_type Operator id type
     *
     * @return $this
     */
