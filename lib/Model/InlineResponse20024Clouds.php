...
/**
 * InlineResponse20024Clouds Class Doc Comment
 *
 * @category Class
 * @package  FlightAware\PHPClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20024Clouds implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_24_clouds';
...
'type' => 'getType'    ];
     ...
     * Sets altitude
     *
     * @param int $altitude Height in feet (AGL) of cloud base
     *
     * @return $this
     */
     ...
     * Sets symbol
     *
     * @param string $symbol Raw cloud symbol from the METAR report
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Type of cloud. May be CLR, FEW, SCT, BKN, OVC, VV
     *
     * @return $this
     */
