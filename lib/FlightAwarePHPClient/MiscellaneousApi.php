...
class MiscellaneousApi
{
    ...
    {
        [$response] = $this->getAircraftOwnerWithHttpInfo($ident);
        return $response;
    }
    ...
    {
        [$response] = $this->getAllDisruptionCountsWithHttpInfo($entity_type, $time_period, $max_pages, $cursor);
        return $response;
    }
    ...
    {
        [$response] = $this->getDisruptionCountsWithHttpInfo($id, $entity_type, $time_period);
        return $response;
    }
    ...
    {
        [$response] = $this->getFlightTypeWithHttpInfo($type);
        return $response;
    }
    ...
    {
        return $this->getSchedulesByDateWithHttpInfo($date_start, $date_end, $origin, $destination, $airline, $flight_number, $include_codeshares, $include_regional, $max_pages, $cursor);
    }
